...
public class Turnos : MonoBehaviour
{
    ...
    public bool Acabado() // editar con m�s formas de que acabe el combate
    {
    ...
    void Mostrar_Guardias()
    {
        Finalizado();
        if (Personaje_1 != null)
            Debug.Log("J1 Guardia: " + Personaje_1.GetGuardia()); // Cambiar cuando gr�ficos
        if (Personaje_2 != null)
            Debug.Log("J2 Guardia: " + Personaje_2.GetGuardia()); // Cambiar cuando gr�ficos
    }
    ...
    void Finalizado()
    {
        ...
        {
            estado = Estado.ENDED;
            Debug.Log("J2 gana!"); // Cambiar cuando gr�ficos

        }
        if (Personaje_2 == null)
        {
            estado = Estado.ENDED;
            Debug.Log("J1 gana!"); // Cambiar cuando gr�ficos
